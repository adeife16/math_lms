  ...
  <div class="col-xl-8 col-md-8">
    <div class="card shadow mb-4">
          ...
          <div class="card-body">
              ...
              <div id="action">
              	<button class="btn btn-success" id="create-quiz" data-toggle="modal" data-target="#addModal">Create Exam</button>
              </div>
          </div>
      </div>
</div>
          ...
          <div class="modal-content">
              ...
              <div class="modal-body">
              	<form class="form" id="create-quiz-form" method="post" action="">
              		...
              		<div class="form-group">
              			<span for="topic">Duration (In Minutes)</span>
              			<input type="number" class="form-control" id="time" name="time" placeholder="Duration (In Minutes)" min="0">
              		</div>
              		<div class="form-group">
